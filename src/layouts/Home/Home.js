...
// List of alternative roles to cycle through in home page
...
export const Home = () => {
  ...
  return (
    <div className={styles.home}>
      <Meta
        title="Film Director + Developer"
        description="Creative portfolio of Aashish Samtani — a film director from Jakarta, Indonesia 
      ...
      <ProjectSummary
        ...
        model={{
          type: 'laptop',
          alt: 'Title thumbnail for the return',
          textures: [
            {
